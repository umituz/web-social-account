...
export class SessionStorageAdapter implements ISessionStorage {
  ...
  // In-memory cache to reduce sessionStorage access (improves performance)
  ...
  /**
   * Initialize cache with existing data from sessionStorage
   */
  private initializeCache(): void {
    try {
      ...
      console.warn("Failed to initialize cache from sessionStorage:", error);
    }
  }

  /**
   * Load cache from sessionStorage for a given prefix
   */
  ...
  /**
   * Get all keys from sessionStorage with a prefix
   */
